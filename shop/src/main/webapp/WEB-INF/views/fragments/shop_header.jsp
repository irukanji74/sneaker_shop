                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-5 contact">
                            <p class="hidden-sm hidden-xs">Контакт нас +420 777 555 333 or hello@universal.com.</p>
...
<sec:csrfInput />
                        ...
                        <p class="text-center text-muted"><a href="<spring:url value="/register/"/>"><strong>Register now</strong></a>! It is easy and done in 1&nbsp;minute and gives you access to special discounts and much more!</p>
